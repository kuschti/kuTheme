	...
	<footer id="footer-wrap" class="row">
		<div id="colophon">
			...
			<?php 
				...
				<span class="footertext">&copy; <?php echo date('Y'); ?> <?php bloginfo(); ?></span><span class="sep"> | </span><span class="footertext"><?php _e('Proudly powered by', 'piha') ?> <a href="http://wordpress.org/" >WordPress</a></span><span class="sep"> | </span><span class="footertext"><?php printf( __( 'Theme: %1$s by %2$s', 'piha' ), 'Piha', '<a href="http://www.elmastudio.de/wordpress-themes/">Elmastudio</a>' ); ?></span>
				<?php } ?></p>
