...
function theme_options_render_page() {
	...
	<div class="wrap">
		<?php screen_icon(); ?>
		<h2><?php printf( __( '%s Theme Options', 'piha' ), get_current_theme() ); ?></h2>
		<?php settings_errors(); ?>
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Custom Favicon', 'piha' ); ?></th>
					<td>
						...
						<br/><label class="description" for="piha_theme_options[custom_favicon]"><?php _e( 'Create a favicon image e.g. with <a href="http://www.faviconr.com/" target="_blank">Faviconr</a>, upload your .ico Favicon image (via FTP) to your server and enter the Favicon URL here.', 'piha' ); ?></label>
						</fieldset>
					</td>
				</tr>
...
$(document).ready(function(){
    	$("#main-nav-mobile .menu").hide();

    $("a.nav-mobile-btn").click(function () {
       $('#main-nav-mobile .menu').slideToggle("400");
    });
});
</script>
<?php
...
input#submit,input.wpcf7-submit {background-color:<?php echo $link_color; ?>;}
